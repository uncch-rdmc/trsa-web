...
import edu.harvard.iq.dataverse.util.DatasetFieldConstant;
...
public class DdiExportUtil {
    ...
    private static void dtoddi(DatasetDTO datasetDto, OutputStream outputStream) throws XMLStreamException {
        ...
        // missing createDataSc
        // createDataDscr (xmlw, DatasetVersion datasetVersion)
    ...
    public static void datasetJson2ddi(JsonObject datasetDtoAsJson, DatasetVersion version, OutputStream outputStream) throws XMLStreamException {
        logger.log(Level.FINE, "+++++++++++++++++++++++++++ DdiExportUtil#datasetJson2ddi starts here +++++++++++++++++++++++++++");
        logger.log(Level.FINE, "Json to dump={0}", JsonUtil.prettyPrint(datasetDtoAsJson.toString()));
        Gson gson = new Gson();
        DatasetDTO datasetDto = gson.fromJson(datasetDtoAsJson.toString(), DatasetDTO.class);
    ...
    private static void createStdyDscr(XMLStreamWriter xmlw, DatasetDTO datasetDto) throws XMLStreamException {
        logger.log(Level.FINE, "DdiExportUtil#createStdyDscr strats here");
        ...
        logger.log(Level.FINE, "persistentAuthority={0}", persistentAuthority);
        logger.log(Level.FINE, "persistentId={0}", persistentId);
        
        //docDesc Block
        writeDocDescElement (xmlw, datasetDto);
        logger.log(Level.FINE, "passed docDesc block");
        //stdyDesc Block
        xmlw.writeStartElement("stdyDscr");
        xmlw.writeStartElement("citation");
        xmlw.writeStartElement("titlStmt");
       logger.log(Level.FINE, "before titl");
        writeFullElement(xmlw, "titl", dto2Primitive(version, DatasetFieldConstant.title));                      logger.log(Level.FINE, "after titl");
        ...
        logger.log(Level.FINE, "before the version");
        ...
        //End Citation Block
        logger.log(Level.FINE, "finish citation block");
        //Start Study Info Block
        // Study Info
        logger.log(Level.FINE, "stdyInfo stars here");
        ...
        // End Info Block
        logger.log(Level.FINE, "The end of Info-block");
        //Social Science Metadata block
               
        writeMethodElement(xmlw, version);
        logger.log(Level.FINE, "writing terms of use and access begins");
        ...
        logger.log(Level.FINE, "DdiExportUtil#createStdyDscr ends here");
    }
    ...
    private static void writeDocDescElement (XMLStreamWriter xmlw, DatasetDTO datasetDto) throws XMLStreamException {
        ...
        String persistentAuthority = datasetDto.getAuthority();
        String persistentId = datasetDto.getIdentifier();
            logger.log(Level.FINE, "pass pa pid assignment");
        ...
        xmlw.writeEndElement(); // docDscr
            ...
            logger.log(Level.FINE, "NullPointerException={0}", ne);
        } catch (RuntimeException re){
            logger.log(Level.FINE, "runtime exception={0}", re);
        }
    }
    ...
    private static void writeVersionStatement(XMLStreamWriter xmlw, DatasetVersionDTO datasetVersionDTO) throws XMLStreamException{
        ...
        if (datasetVersionDTO.getReleaseTime()== null){
            logger.log(Level.WARNING, "datasetVersionDTO has no ReleaseTime; use LastUpdateTime");
            writeAttribute(xmlw,"date", datasetVersionDTO.getLastUpdateTime().substring(0, 10));
        ...
        if (datasetVersionDTO.getVersionNumber() == null){
            logger.log(Level.WARNING, "datasetVersionDTO has no versionNumber");
    ...
    private static void createOtherMats(XMLStreamWriter xmlw, List<FileDTO> fileDtos) throws XMLStreamException {
         logger.log(Level.FINE, "DdiExportUtil#createOtherMats strats here");
        ...
        logger.log(Level.FINE, "DdiExportUtil#createOtherMats ends here");
    }
    ...
    private static void createDataDscr(XMLStreamWriter xmlw, DatasetVersion datasetVersion) throws XMLStreamException {
        logger.log(Level.FINE, "DdiExportUtil#createDataDscr strats here");
        ...
        logger.log(Level.FINE, "DdiExportUtil#createDataDscr ends here");
    }
    
    private static void createVarDDI(XMLStreamWriter xmlw, DataVariable dv) throws XMLStreamException {
         logger.log(Level.FINE, "DdiExportUtil#createVarDDI strats here");
        ...
        logger.log(Level.FINE, "DdiExportUtil#createVarDDI ends here");
    }
    
    private static void createFileDscr(XMLStreamWriter xmlw, DatasetVersion datasetVersion) throws XMLStreamException {
        logger.log(Level.FINE, "DdiExportUtil#createFileDscr strats here");
        String dataverseUrl = getDataverseSiteUrl();
        for (FileMetadata fileMetadata : datasetVersion.getFileMetadatas()) {
            DataFile dataFile = fileMetadata.getDataFile();
...
// AS masked on 2017-11-21: currently not essential
...
//                }
        ...
        logger.log(Level.FINE, "DdiExportUtil#createFileDscr ends here");
    }
